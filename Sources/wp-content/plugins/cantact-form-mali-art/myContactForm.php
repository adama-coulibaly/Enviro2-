...
$content .= '<div align="center"> <h1 style="color:white">Nous contacter</h1> </div>';
...
$content .= '<input  type="submit" value="Envoyer" name="custumcontact_submit" style=" background:white;color:black; width:30%; heigth:40%" />';
$content .= '</div>';
$content .= '</form>';
$content .= '</div>';
$content .= '</body>';
...
// Administrateur system
        $to = 'coulibalyadamabekaye03@gmail.com';
        $NOM = $nom;
        $subject = $objet;
