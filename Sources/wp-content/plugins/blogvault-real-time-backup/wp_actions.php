	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '3c36bd5fa10b93c7352bf87fc5db9008', '39edce9a729a5660d834c776b6d2f981');
		BVAccount::updateApiPublicKey($this->settings, '3c36bd5fa10b93c7352bf87fc5db9008');
			}
