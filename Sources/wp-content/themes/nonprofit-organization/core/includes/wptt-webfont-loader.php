...
if ( ! class_exists( 'Nonprofit_Organization_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Nonprofit_Organization_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Nonprofit_Organization_WPTT_WebFont_Loader( $url );
